...
//reuse these variables for the following problems
var bango1 = 1;
var bango2 = 2;
...
function add(num1, num2){ //THESE ARE PLACEHOLDERS, NOT A DATATYPE
    //or I can do something like var total = num1+num2;
    return num1 + num2; //then return total
}
...
console.log(createFullName("Andrew", "Obiano"));
...
console.log(eatFood("Andrew", "Obiano", "garbage"));
...
function shoeSize(inches){
    return "Your shoe size in centimeters is " + inches/2.54;
}
...
function throwParty(){
    if(canDrink === true){
        ...
        noCanParty = 'Meh, see you at Starbucks.';
        return noCanParty;
    }
}
var party = throwParty();
console.log(party);